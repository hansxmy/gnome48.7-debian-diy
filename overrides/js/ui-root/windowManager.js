...
const MINIMIZE_WINDOW_ANIMATION_TIME = 250;
const MINIMIZE_WINDOW_ANIMATION_MODE = Clutter.AnimationMode.EASE_OUT_EXPO;
const SHOW_WINDOW_ANIMATION_TIME = 120;
const DIALOG_SHOW_WINDOW_ANIMATION_TIME = 80;
const DESTROY_WINDOW_ANIMATION_TIME = 120;
const DIALOG_DESTROY_WINDOW_ANIMATION_TIME = 80;
